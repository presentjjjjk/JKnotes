...
def P_mean(a,b):
    ...
    k2 = a * np.abs(v2_subset - v1_subset)**b
...
bounds = (np.array([0,0]), np.array([100000,1]))

# 创建PSO优化器
optimizer = ps.single.GlobalBestPSO(n_particles=15, dimensions=2, options={'c1': 0.5, 'c2': 0.3, 'w': 0.9}, bounds=bounds)
